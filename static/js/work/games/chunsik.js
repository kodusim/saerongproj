...
const STORY = {
    ...
    magazine: {
        ...
        text: `삼촌이 손에 든 잡지를 툭툭 치며 말했다.<br><br>
            ...
            &ldquo;이거 기반으로 게임을 만들려는디, 제목은 「자네 이름은 이쟈부터
            춘식이여!」로 할 거고, 화제의 작품 『농촌 맥시멈 청년』 원작 기반이라는
            것도 꼭 넣어야 혀. 좀 도와줄랑가?&rdquo;`,
        choices: [
    ...
    ending: {
        ...
        text: `『자네 이름은 이쟈부터 춘식이여!』 — TRUE ENDING<br><br>
            ...
            되었다. 삼촌이 만든다던 게임도 화제의 작품 『농촌 맥시멈 청년』 원작
            기반이라는 문구를 달고 회관 게시판에 나붙었다.<br><br>
